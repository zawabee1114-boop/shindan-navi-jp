...
export const DIAGNOSIS_LIST: DiagnosisInfo[] = [
  ...
  },
  {
    ...
    label: 'MBTI診断',
    icon: '🎭',
    resultPath: '/diagnosis/mbti/',
    diagnosisPath: '/diagnosis/mbti/',
    color: 'var(--sn-diag-mbti)',
  },
  {
    id: 'perfectionism',
    label: '完璧主義タイプ診断',
  ...
  },
  {
    ...
    label: '恋愛スタイル診断',
    icon: '💕',
    resultPath: '/diagnosis/love-style/result/',
    diagnosisPath: '/diagnosis/love-style/',
  ...
  },
  {
    ...
    label: '金銭感覚診断',
    icon: '💰',
    resultPath: '/diagnosis/money-style/result/',
    diagnosisPath: '/diagnosis/money-style/',
  ...
  },
  {
    ...
    label: '友達相性タイプ診断',
    icon: '👥',
    resultPath: '/diagnosis/friend-compat/result/',
    diagnosisPath: '/diagnosis/friend-compat/',
  ...
  },
  {
    ...
    label: '星座性格診断',
    icon: '✨',
    resultPath: '/diagnosis/zodiac/',
    diagnosisPath: '/diagnosis/zodiac/',
  ...
  },
  {
    ...
    label: '血液型性格診断',
    icon: '🩸',
    resultPath: '/diagnosis/blood-compat/',
    diagnosisPath: '/diagnosis/blood-compat/',
